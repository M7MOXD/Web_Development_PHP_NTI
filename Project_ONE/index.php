...
$sql = "SELECT products.*, users.name as user, categories.title as category FROM products INNER JOIN users ON users.user_id = products.addBy INNER JOIN categories ON categories.category_id = products.category_id WHERE products.product_id BETWEEN 9 AND 11";
$slider_op = runQuery($sql);
?>
<!doctype html>
		...
		<header id="home" class="welcome-hero">
			...
			<div id="header-carousel" class="carousel slide carousel-fade" data-ride="carousel">
				...
				<div class="carousel-inner" role="listbox">
					<!-- .item -->
					<?php
					while ($slide = mysqli_fetch_assoc($slider_op)) {
					?>
					<div class="item <?php if ($slide['product_id'] == 9) {echo "active";} ?>">
						<div class="single-slide-item slide<?php echo $slide['product_id'] ?>">
							<div class="container">
											...
											<div class="single-welcome-hero">
												<div class="welcome-hero-txt">
													...
													<div class="packages-price">
														<p>
															$<?php echo $slide['price'] ?>.00
															<del>$ 499.00</del>
														</p>
													</div>
													<button class="btn-cart welcome-add-cart" onclick="window.location.href='admin/addcart.php?id=<?php echo $slide['product_id'] ?>'">
										...
										<div class="col-sm-5">
											<div class="single-welcome-hero">
												<div class="welcome-hero-img">
													<img src="<?php echo url('products/uploads/').$slide['product_img'] ?>" alt="slider image">
												</div><!--/.welcome-hero-txt-->
											</div><!--/.single-welcome-hero-->
										</div><!--/.col-->
									</div><!--/.row-->
				        ...
				        <div class="container">
				            ...
				            <div class="attr-nav">
				                <ul>
				                	...
				                	<li class="nav-setting">
				                		<a href="./admin/"><span class="lnr lnr-cog"></span></a>
				                	</li><!--/.search-->
				                    <li class="dropdown">
				                        ...
				                        <ul class="dropdown-menu cart-list s-cate">
											...
											if (isset($_SESSION['user'])) {
											if ($_SESSION['user']['title'] === "Customer") {
												while ($cart = mysqli_fetch_assoc($cart_op)) {
											?>
				                            <li class="single-cart-list">
				                                <a href="#" class="photo"><img src="<?php echo url('products/uploads/').$cart['product_img'] ?>" class="cart-thumb" alt="image" /></a>
				                                <div class="cart-list-txt">
				                                	<h6><a href="#"><?php echo $cart['name'] ?></a></h6>
				                                	<p>1 x - <span class="price">$<?php echo $cart['price'] ?>.00</span></p>
				                                </div><!--/.cart-list-txt-->
												<a class="lnr lnr-cross" href='admin/delorder.php?id=<?php echo $cart['product_id'] ?>'></a>
				                            </li><!--/.single-cart-list -->
											<?php
											}
											}
				                            ...
				                            <li class="total">
												...
												?>00</span>
				                                <button class="btn-cart pull-right" onclick="window.location.href='admin/cart.php'">view cart</button>
				                            </li>
				                        </ul>
				                    </li><!--/.dropdown-->
				                </ul>
				            ...
				            <div class="collapse navbar-collapse menu-ui-design" id="navbar-menu">
				                <ul class="nav navbar-nav navbar-center" data-in="fadeInDown" data-out="fadeOutUp">
									...
									if (!isset($_SESSION['user'])) {
									?>
				                    <li><a href="http://localhost/php/admin/login.php">Login</a></li>
									<?php
									} else {
									?>
				                    <li><a href="http://localhost/php/admin/logout.php">Logout</a></li>
									<?php
									}
									?>
				                </ul><!--/.nav -->
				...
				<div class="new-arrivals-content">
					<div class="row">
						...
						while ($data = mysqli_fetch_assoc($products_op)) {
							if ($data['product_id'] == 9 || $data['product_id'] == 10 || $data['product_id'] == 11) {
								continue;
							}
						?>
						<div class="col-md-3 col-sm-4">
							<div class="single-new-arrival">
								<div class="single-new-arrival-bg">
									<img src="<?php echo url('products/uploads/').$data['product_img'] ?>" alt="new-arrivals images">
								...
								<h4><a href="<?php echo url('addcart.php').'?id='.$data['product_id'] ?>"><?php echo $data['name'] ?></a></h4>
