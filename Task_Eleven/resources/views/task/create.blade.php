...
<body class="container my-3 mx-auto">
    ...
    @endif
    <form class="row g-3 container mx-auto" action="{{url('task')}}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="col-md-6">
            ...
            <input type="date" class="form-control" id="inputStart" name="start_date" value="<?php echo old('start_date'); ?>">
        </div>
        <div class="col-md-6">
            <label for="inputEnd" class="form-label">End</label>
            <input type="date" class="form-control" id="inputEnd" name="end_date" value="<?php echo old('end_date'); ?>">
        </div>
        <div class="col-md-12">
